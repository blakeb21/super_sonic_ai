      ...
      <main className="min-h-screen">
        ...
        <article>
          <div className="container mx-auto flex flex-col p-6 md:px-8 lg:px-16">
            ...
            <Image className="mx-auto p-4 lg:max-w-5xl" alt="The first loop in Sonic that is the biggest barrier to advancement in level 1" src={loop} width={1244} height={818}></Image>
