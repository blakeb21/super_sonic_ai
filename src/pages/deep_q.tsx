      ...
      <main className="min-h-screen">
        ...
        <article>
          <div className="container mx-auto flex flex-col text-center p-6 md:px-8 lg:px-16">
            ...
            <p className="text-center">Source: <a target="_blank" href="https://www.analyticsvidhya.com/blog/2019/04/introduction-deep-q-learning-python/" rel="noopener noreferrer" className="text-yellow-400 underline hover:text-yellow-600">https://www.analyticsvidhya.com/blog/2019/04/introduction-deep-q-learning-python/</a></p>
          </div>
        </article>
        <article>
